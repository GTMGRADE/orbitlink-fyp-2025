...
class User:
    def __init__(self, id=None, email=None, username=None, password=None, created_at=None, status='active', subscription_active=False):
        self.id = id
        self.email = email
        ...
        self.status = status
        self.subscription_active = subscription_active  # Add subscription field
    ...
    def create_user(email, username, password):
        ...
        return User(
            ...
            subscription_active=False  # Default to not subscribed
        )
