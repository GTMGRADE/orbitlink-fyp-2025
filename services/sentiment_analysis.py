...
try:
    print("[PRELOAD] Starting sentiment resources preload...")
    preload_sentiment_resources()
    print("[PRELOAD] Sentiment resources preloaded successfully")
except Exception as e:
    print(f"[PRELOAD] Warning - some resources failed to preload: {e}")
    import traceback
    traceback.print_exc()
    # Don't fail - resources will be loaded on first use
